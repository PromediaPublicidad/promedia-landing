...
export default function Footer() {
  ...
  return (
    <footer id="contacto" className="relative bg-[#0f1f25] text-white overflow-x-clip">
      {/* Contenedor centrado */}
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          {/* Columna de mapa */}
          <div className="w-full h-[300px] md:h-[350px] rounded-xl overflow-hidden shadow-lg ring-1 ring-white/10">
            <iframe
